...
import { formatDateRO, getWeekdayRO, isWorkingDay, nextWorkingDay, prevWorkingDay } from './dateUtils';
      ...
      <section className="max-w-xl w-full mb-6">
        ...
        <div className="border rounded p-4 bg-gray-50 text-gray-900 text-center flex justify-center">
          <DatePicker
            ...
            placeholderText="Alege data de început"
